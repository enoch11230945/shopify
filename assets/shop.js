...
(function ($) {
    ...
    _docBody.on('click', '.js_quick_view', function (e) {
        ...
        $.getJSON($(this).attr('href').split('?')[0] + '.js', function (product) {
            ...
            $.getScript("//besthomeandkitchen.com/cdn/shopifycloud/shopify/assets/themes_support/option_selection-86cdd286ddf3be7e25d68b9fc5965d7798a3ff6228ff79af67b3f4e41d6a34be.js", function () {
    ...
    var zmz = {
        ...
        itemAccordion: function () {
            var detAcc = document.querySelector('.item-accordion-js');
